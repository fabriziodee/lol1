...
await this.reply(m.key.remoteJid, deltext, m.message, { quoted: m, contextInfo: { externalAdReply: { title: '🎋 Lᴏʟɪʙᴏᴛ Tᴇᴀᴍ Sᴜᴘᴘᴏʀᴛ 🎋', description: '➤ Antidelete By Gatito', previewType:"PHOTO", thumbnail: very, sourceUrl:`` }, mentionedJid: [m.participant] } })
