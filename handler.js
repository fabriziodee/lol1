        ...
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              let addaction = ([[action === 'add' ? "[{ buttonId: 'gracias', buttonText: { displayText: 'Gracias 💖' }, type: 1 }, { buttonId: 'descripción', buttonText: { displayText: 'Descripción ☕' }, type: 1 }]" : "[{ buttonId: 'gracias', buttonText: { displayText: 'Adios 👋' }, type: 1 }]"]])
              let gbutsan = addaction
