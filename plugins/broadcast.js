...
let handler  = async (m, { conn, text, participants }) => {
  ...
  let fakereply = { key : { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "51940617554-1621199330@g.us" }, message: { orderMessage: { itemCount : 2022, status: 1, surface : 1, message: '↷✦╎Anuncio lolibot╎💌˖ ⸙', orderTitle: "↷✦╎Anuncio lolibot╎💌˖ ⸙", thumbnail: faketumb, sellerJid: '0@s.whatsapp.net' } } }
