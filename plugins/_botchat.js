...
if (audio16B) {
	...
	let vn = ss[Math.floor(Math.random() * ss.length)]
        ...
        conn.sendMessage(m.chat, fs.readFileSync(vn), MessageType.sticker, { quoted: m, contextInfo: { externalAdReply: {title: conn.getName(m.sender), body:"© lolibot", previewType: "VIDEO", thumbnail: ppp, sourceUrl: ""}}})
        } else
