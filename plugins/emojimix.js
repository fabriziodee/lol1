...
await m.reply(`${JSON.stringify(anu.results[0].media_formats.png_transparent.url, null, 1)}`)
if (anu.results[0].media_formats.png_transparent.url == undefined) throw 'No se encontró el emoji'
