...
//Test
  ...
  let fakereply = { key : { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ?  { remoteJid: "51940617554-1621199330@g.us" } : {}) }, message: { orderMessage: { itemCount : 2022, status: 1, surface : 1, message: '↷✦╎lolibot╎💌˖ ⸙', orderTitle: "↷✦╎lolibot╎💌˖ ⸙", thumbnail: faketumb, sellerJid: '0@s.whatsapp.net' } } }
