...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    text = text.replace(new RegExp(`%(${Object.keys(replace).sort((a, b) => b.length - a.length).join`|`})`, 'g'), (_, name) => '' + replace[name])
     ...
     conn.relayWAMessage(await conn.prepareMessageFromContent(m.chat, {productMessage: { businessOwnerJid: '51940617554@s.whatsapp.net', product: { productId: '750', productImage:imeu, title: '💌 Lobita & Gatito 💫', description: text.trim(), currencyCode: 'IDR', priceAmount1000: '2022', retailerId: '750', url: 'https://wa.me/51940617554', productImageCount: 1, salePriceAmount1000: '7.8000', } } }, { quoted: m }))
