...
conn.sendMessage(m.chat, teks.trim(), MessageType.text, { quoted: m, contextInfo: { "mentionedJid": memberr } })}
...
//await conn.sendFile(m.chat, vn, 'Invocar.mp3', null, m, true, { type: 'audioMessage', ptt: true })
}
